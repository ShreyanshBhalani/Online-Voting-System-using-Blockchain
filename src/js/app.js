...
App = {
  ...
  initWeb3: async function() {
    ...
    if (window.ethereum) {
      try {
        ...
        console.log("inside try-set accounts")
      } catch (error) {
        if (error.code === 4001) {
  ...
  initContract: function() {
    ...
    $.getJSON("Contest.json",function(contest){
      ...
      console.log(App.contracts.Contest,"idkkkk")

      App.contracts.Contest.setProvider(web3.currentProvider);
      console.log(web3.currentProvider,"TRYY")
      console.log(App.contracts.Contest.setProvider(web3.currentProvider),"herooo")
